<#
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Remove-PokeModuleSettings.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Remove-PokeModuleSettings.Tests.ps1 -Output Detailed
...
#Available inside It but NOT Describe or Context
    ...
    AfterAll{
        ...
        Remove-PokeModuleSettings -PokeConfPath $exportPath -WarningAction SilentlyContinue
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('moduleSettings') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "No configuration should throw a warning" {
            Remove-PokeModuleSettings -PokeConfPath $invalidPath -WarningAction SilentlyContinue -WarningVariable moduleSettingsWarning
        ...
        It "Saved configuration should be removed" {
            ...
            [bool](Get-Variable -Name Poke_Base_URI -ErrorAction SilentlyContinue)   | Should -BeTrue
        }
        ...
        It "Saved configuration & variables should be removed" {
            ...
            Export-PokeModuleSettings -PokeConfPath $exportPath -WarningAction SilentlyContinue
            Remove-PokeModuleSettings -PokeConfPath $exportPath -andVariables

            Test-Path -Path $exportPath | Should -BeFalse
            [bool](Get-Variable -Name Poke_Base_URI -ErrorAction SilentlyContinue)   | Should -BeFalse
        }
