<#
    .SYNOPSIS
        Pester tests for the PokeAPI baseURI functions
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\baseUri\Get-PokeBaseURI.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\baseUri\Get-PokeBaseURI.Tests.ps1 -Output Detailed
...
Context "[ $commandName ] testing functions" {
    ...
    It "[ $commandName ] should have an alias of [ Set-PokeBaseURI ]" {
        Get-Alias -Name Set-PokeBaseURI | Should -BeTrue
    }

    It "Without parameters should return the default URI" {
        Add-PokeBaseURI
        Get-PokeBaseURI | Should -Be 'https://pokeapi.co/api/v2'
    }

    It "Should accept a value from the pipeline" {
        'https://celerium.org' | Add-PokeBaseURI
        Get-PokeBaseURI | Should -Be 'https://celerium.org'
    }

    It "With parameter -base_uri <value> should return what was inputted" {
        Add-PokeBaseURI -base_uri 'https://celerium.org'
        Get-PokeBaseURI | Should -Be 'https://celerium.org'
    }
