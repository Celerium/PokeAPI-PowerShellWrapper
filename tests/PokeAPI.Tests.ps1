...
.SYNOPSIS
    Pester tests for the PokeAPI module manifest file.
...
.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-PokeAPIKey.Tests.ps1

    Runs a pester test and outputs simple results

.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-PokeAPIKey.Tests.ps1 -Output Detailed
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'PokeAPI.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'd6c6b73e-d0ad-4d09-8a24-a5a05064d26c'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/PokeAPI-PowerShellWrapper/blob/main/LICENSE'
        }
        ...
        It "Manifest [ AliasesToExport ] has alias" {
            switch ($buildTarget){
                'built'     { ($Module.ExportedAliases | Measure-Object).Count |  Should -Be 1 }
                'notBuilt'  { $Module.ExportedAliases |  Should -Not -BeNullOrEmpty }
            }
        }

        It "Manifest [ Tags ] has valid data" {
            $Module.PrivateData.PSData.Tags | Should -Contain 'PokeAPI'
        ...
        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/PokeAPI-PowerShellWrapper/blob/main/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/PokeAPI-PowerShellWrapper'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/PokeAPI-PowerShellWrapper/main/.github/images/Celerium_PoSHGallery_PokeAPI.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/PokeAPI-PowerShellWrapper/blob/main/README.md'
        }
