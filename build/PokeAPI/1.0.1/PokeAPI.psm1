#Region '.\Private\apiCalls\ConvertTo-PokeQueryString.ps1' 0
...
#EndRegion '.\Private\apiCalls\ConvertTo-PokeQueryString.ps1' 95
#Region '.\Private\apiCalls\Get-PokeMetaData.ps1' 0
...
#Region '.\Private\apiCalls\Invoke-PokeRequest.ps1' 0
...
#Region '.\Private\baseUri\Add-PokeBaseURI.ps1' 0
...
#Region '.\Private\baseUri\Get-PokeBaseURI.ps1' 0
...
#Region '.\Private\baseUri\Remove-PokeBaseURI.ps1' 0
...
#Region '.\Private\moduleSettings\Export-PokeModuleSettings.ps1' 0
...
#Region '.\Private\moduleSettings\Get-PokeModuleSettings.ps1' 0
...
#Region '.\Private\moduleSettings\Import-PokeModuleSettings.ps1' 0
...
#Region '.\Private\moduleSettings\Initialize-PokeModuleSettings.ps1' 0
...
#Region '.\Private\moduleSettings\Remove-PokeModuleSettings.ps1' 0
...
#Region '.\Public\berry\Get-PokeBerry.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/berry" }
            'index_ById'   { $resource_uri = "/berry/$id" }
            'index_ByName' { $resource_uri = ("/berry/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_BerryParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\berry\Get-PokeBerry.ps1' 107
#Region '.\Public\berry\Get-PokeBerryFirmness.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/berry-firmness" }
            'index_ById'   { $resource_uri = "/berry-firmness/$id" }
            'index_ByName' { $resource_uri = ("/berry-firmness/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_BerryFirmnessParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\berry\Get-PokeBerryFirmness.ps1' 107
#Region '.\Public\berry\Get-PokeBerryFlavor.ps1' 0
...
#EndRegion '.\Public\berry\Get-PokeBerryFlavor.ps1' 107
#Region '.\Public\contest\Get-PokeContestEffect.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/contest-effect" }
            'index_ById'   { $resource_uri = "/contest-effect/$id" }
            'index_ByName' { $resource_uri = ("/contest-effect/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_ContestEffectParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\contest\Get-PokeContestEffect.ps1' 106
#Region '.\Public\contest\Get-PokeContestSuperEffect.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/super-contest-effect" }
            'index_ById'   { $resource_uri = "/super-contest-effect/$id" }
            'index_ByName' { $resource_uri = ("/super-contest-effect/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_ContestSuperEffectParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\contest\Get-PokeContestSuperEffect.ps1' 108
#Region '.\Public\contest\Get-PokeContestType.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/contest-type" }
            'index_ById'   { $resource_uri = "/contest-type/$id" }
            'index_ByName' { $resource_uri = ("/contest-type/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_ContestTypeParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\contest\Get-PokeContestType.ps1' 107
#Region '.\Public\encounter\Get-PokeEncounterCondition.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/encounter-condition" }
            'index_ById'   { $resource_uri = "/encounter-condition/$id" }
            'index_ByName' { $resource_uri = ("/encounter-condition/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_EncounterConditionParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\encounter\Get-PokeEncounterCondition.ps1' 107
#Region '.\Public\encounter\Get-PokeEncounterConditionValue.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/encounter-condition-value" }
            'index_ById'   { $resource_uri = "/encounter-condition-value/$id" }
            'index_ByName' { $resource_uri = ("/encounter-condition-value/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_EncounterConditionValueParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\encounter\Get-PokeEncounterConditionValue.ps1' 108
#Region '.\Public\encounter\Get-PokeEncounterMethod.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/encounter-method" }
            'index_ById'   { $resource_uri = "/encounter-method/$id" }
            'index_ByName' { $resource_uri = ("/encounter-method/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_EncounterMethodParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\encounter\Get-PokeEncounterMethod.ps1' 107
#Region '.\Public\evolution\Get-PokeEvolutionChain.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/evolution-chain" }
            'index_ById'   { $resource_uri = "/evolution-chain/$id" }
            'index_ByName' { $resource_uri = ("/evolution-chain/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_EvolutionChainParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\evolution\Get-PokeEvolutionChain.ps1' 108
#Region '.\Public\evolution\Get-PokeEvolutionTrigger.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/evolution-trigger" }
            'index_ById'   { $resource_uri = "/evolution-trigger/$id" }
            'index_ByName' { $resource_uri = ("/evolution-trigger/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_EvolutionTriggerParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\evolution\Get-PokeEvolutionTrigger.ps1' 106
#Region '.\Public\game\Get-PokeGameGeneration.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/generation" }
            'index_ById'   { $resource_uri = "/generation/$id" }
            'index_ByName' { $resource_uri = ("/generation/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_GameGenerationParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\game\Get-PokeGameGeneration.ps1' 110
#Region '.\Public\game\Get-PokeGamePokedex.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/pokedex" }
            'index_ById'   { $resource_uri = "/pokedex/$id" }
            'index_ByName' { $resource_uri = ("/pokedex/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_GamePokedexParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\game\Get-PokeGamePokedex.ps1' 108
#Region '.\Public\game\Get-PokeGameVersion.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/version" }
            'index_ById'   { $resource_uri = "/version/$id" }
            'index_ByName' { $resource_uri = ("/version/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_GameVersionParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\game\Get-PokeGameVersion.ps1' 106
#Region '.\Public\game\Get-PokeGameVersionGroup.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/version-group" }
            'index_ById'   { $resource_uri = "/version-group/$id" }
            'index_ByName' { $resource_uri = ("/version-group/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_GameVersionGroupParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\game\Get-PokeGameVersionGroup.ps1' 107
#Region '.\Public\item\Get-PokeItem.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/item" }
            'index_ById'   { $resource_uri = "/item/$id" }
            'index_ByName' { $resource_uri = ("/item/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_ItemParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\item\Get-PokeItem.ps1' 110
#Region '.\Public\item\Get-PokeItemAttribute.ps1' 0
...
#EndRegion '.\Public\item\Get-PokeItemAttribute.ps1' 107
#Region '.\Public\item\Get-PokeItemCategory.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/item-category" }
            'index_ById'   { $resource_uri = "/item-category/$id" }
            'index_ByName' { $resource_uri = ("/item-category/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_ItemCategoryParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\item\Get-PokeItemCategory.ps1' 106
#Region '.\Public\item\Get-PokeItemFlingEffect.ps1' 0
...
#EndRegion '.\Public\item\Get-PokeItemFlingEffect.ps1' 106
#Region '.\Public\item\Get-PokeItemPocket.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/item-pocket" }
            'index_ById'   { $resource_uri = "/item-pocket/$id" }
            'index_ByName' { $resource_uri = ("/item-pocket/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_ItemPocketParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\item\Get-PokeItemPocket.ps1' 106
#Region '.\Public\location\Get-PokeLocation.ps1' 0
...
#EndRegion '.\Public\location\Get-PokeLocation.ps1' 108
#Region '.\Public\location\Get-PokeLocationArea.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/location-area" }
            'index_ById'   { $resource_uri = "/location-area/$id" }
            'index_ByName' { $resource_uri = ("/location-area/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_LocationAreaParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\location\Get-PokeLocationArea.ps1' 108
#Region '.\Public\location\Get-PokeLocationPalParkArea.ps1' 0
...
#EndRegion '.\Public\location\Get-PokeLocationPalParkArea.ps1' 108
#Region '.\Public\location\Get-PokeLocationRegion.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/region" }
            'index_ById'   { $resource_uri = "/region/$id" }
            'index_ByName' { $resource_uri = ("/region/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_LocationRegionParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\location\Get-PokeLocationRegion.ps1' 109
#Region '.\Public\machine\Get-PokeMachine.ps1' 0
...
#EndRegion '.\Public\machine\Get-PokeMachine.ps1' 96
#Region '.\Public\move\Get-PokeMove.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/move" }
            'index_ById'   { $resource_uri = "/move/$id" }
            'index_ByName' { $resource_uri = ("/move/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_MoveParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\move\Get-PokeMove.ps1' 109
#Region '.\Public\move\Get-PokeMoveAilment.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/move-ailment" }
            'index_ById'   { $resource_uri = "/move-ailment/$id" }
            'index_ByName' { $resource_uri = ("/move-ailment/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_MoveAilmentParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\move\Get-PokeMoveAilment.ps1' 106
#Region '.\Public\move\Get-PokeMoveBattleStyle.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/move-battle-style" }
            'index_ById'   { $resource_uri = "/move-battle-style/$id" }
            'index_ByName' { $resource_uri = ("/move-battle-style/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_MoveBattleStyleParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\move\Get-PokeMoveBattleStyle.ps1' 106
#Region '.\Public\move\Get-PokeMoveCategory.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/move-category" }
            'index_ById'   { $resource_uri = "/move-category/$id" }
            'index_ByName' { $resource_uri = ("/move-category/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_MoveCategoryParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\move\Get-PokeMoveCategory.ps1' 106
#Region '.\Public\move\Get-PokeMoveDamageClass.ps1' 0
...
#EndRegion '.\Public\move\Get-PokeMoveDamageClass.ps1' 106
#Region '.\Public\move\Get-PokeMoveLearnMethod.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/move-learn-method" }
            'index_ById'   { $resource_uri = "/move-learn-method/$id" }
            'index_ByName' { $resource_uri = ("/move-learn-method/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_MoveLearnMethodParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\move\Get-PokeMoveLearnMethod.ps1' 106
#Region '.\Public\move\Get-PokeMoveTarget.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/move-target" }
            'index_ById'   { $resource_uri = "/move-target/$id" }
            'index_ByName' { $resource_uri = ("/move-target/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_MoveTargetParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\move\Get-PokeMoveTarget.ps1' 108
#Region '.\Public\pokemon\Get-PokePokemon.ps1' 0
...
#EndRegion '.\Public\pokemon\Get-PokePokemon.ps1' 110
#Region '.\Public\pokemon\Get-PokePokemonAbility.ps1' 0
...
#EndRegion '.\Public\pokemon\Get-PokePokemonAbility.ps1' 107
#Region '.\Public\pokemon\Get-PokePokemonCharacteristic.ps1' 0
...
#EndRegion '.\Public\pokemon\Get-PokePokemonCharacteristic.ps1' 109
#Region '.\Public\pokemon\Get-PokePokemonColor.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/pokemon-color" }
            'index_ById'   { $resource_uri = "/pokemon-color/$id" }
            'index_ByName' { $resource_uri = ("/pokemon-color/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonColorParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonColor.ps1' 108
#Region '.\Public\pokemon\Get-PokePokemonEggGroup.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/egg-group" }
            'index_ById'   { $resource_uri = "/egg-group/$id" }
            'index_ByName' { $resource_uri = ("/egg-group/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonEggGroupParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonEggGroup.ps1' 107
#Region '.\Public\pokemon\Get-PokePokemonEncounter.ps1' 0
...
#EndRegion '.\Public\pokemon\Get-PokePokemonEncounter.ps1' 65
#Region '.\Public\pokemon\Get-PokePokemonForm.ps1' 0
function Get-PokeBerry {
<#
    .SYNOPSIS
...
#EndRegion '.\Public\pokemon\Get-PokePokemonForm.ps1' 109
#Region '.\Public\pokemon\Get-PokePokemonGender.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/gender" }
            'index_ById'   { $resource_uri = "/gender/$id" }
            'index_ByName' { $resource_uri = ("/gender/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonGenderParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonGender.ps1' 108
#Region '.\Public\pokemon\Get-PokePokemonGrowthRate.ps1' 0
...
#EndRegion '.\Public\pokemon\Get-PokePokemonGrowthRate.ps1' 106
#Region '.\Public\pokemon\Get-PokePokemonHabitat.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/pokemon-habitat" }
            'index_ById'   { $resource_uri = "/pokemon-habitat/$id" }
            'index_ByName' { $resource_uri = ("/pokemon-habitat/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonHabitatParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonHabitat.ps1' 107
#Region '.\Public\pokemon\Get-PokePokemonNature.ps1' 0
...
#EndRegion '.\Public\pokemon\Get-PokePokemonNature.ps1' 106
#Region '.\Public\pokemon\Get-PokePokemonPokeathlonStat.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/pokeathlon-stat" }
            'index_ById'   { $resource_uri = "/pokeathlon-stat/$id" }
            'index_ByName' { $resource_uri = ("/pokeathlon-stat/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonPokeathlonStatParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonPokeathlonStat.ps1' 108
#Region '.\Public\pokemon\Get-PokePokemonShape.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/pokemon-shape" }
            'index_ById'   { $resource_uri = "/pokemon-shape/$id" }
            'index_ByName' { $resource_uri = ("/pokemon-shape/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonShapeParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonShape.ps1' 106
#Region '.\Public\pokemon\Get-PokePokemonSpecies.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/pokemon-species" }
            'index_ById'   { $resource_uri = "/pokemon-species/$id" }
            'index_ByName' { $resource_uri = ("/pokemon-species/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonSpeciesParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonSpecies.ps1' 110
#Region '.\Public\pokemon\Get-PokePokemonStat.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/stat" }
            'index_ById'   { $resource_uri = "/stat/$id" }
            'index_ByName' { $resource_uri = ("/stat/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonStatParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonStat.ps1' 108
#Region '.\Public\pokemon\Get-PokePokemonType.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/type" }
            'index_ById'   { $resource_uri = "/type/$id" }
            'index_ByName' { $resource_uri = ("/type/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_PokemonTypeParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\pokemon\Get-PokePokemonType.ps1' 109
#Region '.\Public\utility\Get-PokeEndpoint.ps1' 0
...
#EndRegion '.\Public\utility\Get-PokeEndpoint.ps1' 51
#Region '.\Public\utility\Get-PokeLanguage.ps1' 0
...
#>
    ...
    process {
        ...
        switch ( $PSCmdlet.ParameterSetName ) {
            'index_ByAll'  { $resource_uri = "/language" }
            'index_ById'   { $resource_uri = "/language/$id" }
            'index_ByName' { $resource_uri = ("/language/$name").ToLower() }
        }

        Write-Verbose "Running the [ $($PSCmdlet.ParameterSetName) ] parameterSet"

        Set-Variable -Name 'PokeAPI_LanguageParameters' -Value $PSBoundParameters -Scope Global -Force
...
#EndRegion '.\Public\utility\Get-PokeLanguage.ps1' 106
