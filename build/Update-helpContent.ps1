...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "PokeAPI-PowerShellWrapper\docs"
        NO  - "PokeAPI-PowerShellWrapper\PokeAPI\docs"

    Example: "C:\Celerium\Projects\PokeAPI-PowerShellWrapper\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "PokeAPI-PowerShellWrapper\docs"
    Reference:
        Yes - "PokeAPI-PowerShellWrapper\docs\Endpoints.csv"
        NO  - "PokeAPI-PowerShellWrapper\PokeAPI\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\PokeAPI-PowerShellWrapper\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/PokeAPI-PowerShellWrapper"
...
.EXAMPLE
    .\Update-helpContent.ps1
        -moduleName PokeAPI
        -helpDocsPath "C:\Celerium\Projects\PokeAPI-PowerShellWrapper\docs"
        -csvFilePath "C:\Celerium\Projects\PokeAPI-PowerShellWrapper\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/PokeAPI-PowerShellWrapper"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the Poke API.'
