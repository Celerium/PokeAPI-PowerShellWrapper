...
### index_ByAll (Default)
```powershell
Get-PokeBerryFirmness [-offset <Int32>] [-limit <Int32>] [-allPages] [-updateCache] [<CommonParameters>]
```

### index_ById
```powershell
Get-PokeBerryFirmness -id <Int32> [-updateCache] [<CommonParameters>]
```

### index_ByName
```powershell
Get-PokeBerryFirmness -name <String> [-updateCache] [<CommonParameters>]
```
